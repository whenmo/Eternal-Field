...
public:
	DataManager();
	bool ReadDB(sqlite3* pDB, bool is_diy);
	...
	std::wstring FormatFrom(unsigned int attribute) const;
	...
	std::wstring FormatMoveMarker(unsigned int move_marker) const;
	...
	static constexpr int STRING_ID_FROM = 1010;
